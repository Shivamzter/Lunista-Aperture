...
function configurePipeline(pipeline) {
  ...
  pipeline.createObjectShader("basic", Usage.BASIC).vertex("objects/basic.vsh").fragment("objects/basic.fsh").target(0, mainTexture).target(1, lightmapTex).target(2, normalTex).compile();
